...
Tree* loadBalancedTreeFromData(Node** data, int n) {
	...
	t = tree_ini((destroy_elementtree_function_type) node_destroy, (copy_elementtree_function_type) node_copy, (print_elementtree_function_type) node_print, (cmp_elementtree_function_type) node_cmp);
