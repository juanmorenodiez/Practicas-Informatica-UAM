...
/**
* @brief Crea e inicializa un nodo de una lista.
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param
...
/**
* @brief destruye el nodo de una lista
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
...
/**
* @brief inserta un elemento en una lista por el final
* de esta.
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
...
/**
* @brief extrae un elemento de una lista por
* el principio.
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param List *list
* @return void *pe, NULL si se ha producido
* algun error.
*/
...
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param const List *list
* @return Bool, segun la lista este vacia
* o no.
*/
...
/**
* @brief devuelve el tamanio de una lista.
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param const List *list
...
/**
* @brief inserta un elemento en una lista por el principio
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param List *list
...
/**
* @brief inserta un elemento en una lista en orden
* (de menor a mayor)
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
...
/**
* @brief extrae un elemento de la lista por el final
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param List *list
...
/**
* @brief devuelve la informacion almacenada del nodo
* i-esimo de una lista.
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param List *list
* @param int index
* @return NodeList *nl, NULL si error
*/
...
/**
* @brief imprime una lista dada
* @date 15/04/2019
* @author: Camilo Jené Conde y Juan Moreno Diez
*
* @param FILE *fs
* @param const List *list
* @return int bytes (numero de caracteres)
*/
