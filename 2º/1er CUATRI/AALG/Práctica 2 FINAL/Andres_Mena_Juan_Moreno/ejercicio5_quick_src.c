...
int main(int argc, char** argv)
{
  ...
  printf("Practica numero 2, apartado 5.2\n");
  printf("Realizada por: Andrés Mena y Juan Moreno\n");
  printf("Grupo: 9(1272)\n");
  ...
  ret = genera_tiempos_ordenacion(quicksort_src, nombre,num_min, num_max,incr, n_perms);
