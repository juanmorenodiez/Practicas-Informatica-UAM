 ...
 */
public class Main1 {
	public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException, InvalidIDException, InvalidRequestException {
		...
		sistema.setApoyosFinanciacion(0);
		...
		sistema.setApoyosFinanciacion(13);
