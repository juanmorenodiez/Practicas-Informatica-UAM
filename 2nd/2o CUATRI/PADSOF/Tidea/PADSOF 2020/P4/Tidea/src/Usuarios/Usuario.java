...
public class Usuario implements Serializable {
	...
	public Usuario(String nombre, String NIF, String password) {
		...
		this.notificaciones = new LinkedHashSet<Notificacion>();
		this.proyectosSuscrito = new ArrayList<Proyecto>();
		this.setLogin(false);
	}
	...
	/**
	 * Anade un proyecto a los proyectos del usuario.
	 * @param p Proyecto a andir.
	 */
	...
	/**
	 * Anade un proyecto a los proyectos de representante del usuario.
	 * @param p Proyecto a anadir.
	 */
	...
	/**
	 * Getter de los proyectos a los que esta suscrito.
	 * @return Proyectos suscrito.
	 */
	...
	/**
	 * Anade un proyecto a la lista de los proyectos a los que esta suscrito.
	 * @param pS Proyecto a anadir.
	 */
	 ...
	 */
	public void loginUsuario(String NIF, String password)
	...
	public Colectivo crearColectivo(String nombre) throws ClassNotFoundException, IOException, InvalidIDException {
		...
		if (this.isLogin() == true) {
			if (Sistema.getInstancia().getColectivos().isEmpty()) {
				...
				this.colectivosdeUsuario.add(primero);
				return primero;
			}
			...
			for (Colectivo colectivo : Sistema.getInstancia().getColectivos()) {
				if (colectivo.getNombre().equals(c.getNombre())) {
					...
					this.colectivosdeUsuario.add(c);
					return c;
				}
			}
		}
	...
	/**
	 * Mira si el usuario contiene notificaciones similares.
	 * @param notificacion Notificacion a observar
	 * @return
	 */
	public boolean contieneNotificacion (Notificacion notificacion) {
		if (this.getNotificaciones() == null) {
			return false;
		}
		
		for (Notificacion n : this.getNotificaciones()) {
			if (n.getProyectoNotif().equals(notificacion.getProyectoNotif()) && n.getTipo().equals(notificacion.getTipo())) {
				return true;
			}
		}
		return false;		
	...
	public String toString() {
		return "" + this.getNombre() + ",   Estado del Usuario:  " + this.getEstado();
	}
