...
public class GetPagos extends ServletRaiz {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        List<PagoBean> arrayPagos = null;

        BindingProvider bp = (BindingProvider) dao;

        bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, getServletContext().getInitParameter("server"));
		/* Se recoge de la petici&oacute;n el par&aacute;metro idComercio*/
		String idComercio = request.getParameter(PARAM_ID_COMERCIO);

        arrayPagos = dao.getPagos(idComercio);
        longitud = arrayPagos.size();

		/* Petici&oacute;n de los pagos para el comercio */
		PagoBean[] pagos = arrayPagos.toArray(new PagoBean[longitud]);
